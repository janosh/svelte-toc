<script lang="ts">
  ...
  let collapse_mode: boolean | `h${2 | 3 | 4 | 5 | 6}` = $state(false)
...
<div class="container">
  ...
  <Toc
    ...
    headingSelector=":is(h2, h3, h4, h5):not(.toc-exclude)"
  />
</div>
