...
- Use heading-anchors from svelte-multiselect, rename props to camelCase by @janosh in https://github.com/janosh/svelte-toc/pull/66
- Migrate from mdsvexamples to svelte-multiselect/live-examples by @janosh in https://github.com/janosh/svelte-toc/pull/67
- Add hideOnIntersect prop to auto-hide TOC when overlapping elements by @janosh in https://github.com/janosh/svelte-toc/pull/68
- Add collapseSubheadings prop to dynamically show/hide nested TOC items by @janosh in https://github.com/janosh/svelte-toc/pull/69
- Prevent TOC list-style override and demo layout shifts by @janosh in https://github.com/janosh/svelte-toc/pull/72
